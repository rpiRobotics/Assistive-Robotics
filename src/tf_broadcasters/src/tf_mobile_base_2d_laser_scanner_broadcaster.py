...
"""
Author: Burak Aksoy
Node: tf_mobile_base_2d_laser_scanner_broadcaster
Description:
    Broadcasts to tf2 the trasformation between the 2d_laser_scanner frame
    ...
    but it will be defined somewhere else after the switch to Lidar + 2d_laser_scanner based localization is done from vision aruco localization)
    ...
    'oarbot_xxx_tf_mobile_base_2d_laser_scanner.yaml'
    This yaml file also used to get the pre-calculated pose btw the mobile_base and the 2d_laser_scanner named
    'mobile_base22d_laser_scanner_pose'
    ...
    If is_fixed_z is true, the translational z value in the 'mobile_base22d_laser_scanner_pose' will be used.
...
class MobileBase22d_laser_scannerTf():
    def __init__(self):
        rospy.init_node('tf_mobile_base_2d_laser_scanner_broadcaster', anonymous=True)
        ...
        self.tf_2d_laser_scanner_frame_id = rospy.get_param("~tf_2d_laser_scanner_frame_id", "root_right_arm")
    
        self.mobile_base22d_laser_scanner_pose = rospy.get_param("~mobile_base22d_laser_scanner_pose") 
    ...
    def publish_tf_static(self):
        ...
        t.child_frame_id = self.tf_2d_laser_scanner_frame_id

        t.transform.translation.x = self.mobile_base22d_laser_scanner_pose['position']['x']
        t.transform.translation.y = self.mobile_base22d_laser_scanner_pose['position']['y']
        t.transform.translation.z = self.mobile_base22d_laser_scanner_pose['position']['z'] + self.z_height
        ...
        t.transform.rotation.x = self.mobile_base22d_laser_scanner_pose['orientation']['x']
        t.transform.rotation.y = self.mobile_base22d_laser_scanner_pose['orientation']['y']
        t.transform.rotation.z = self.mobile_base22d_laser_scanner_pose['orientation']['z']
        t.transform.rotation.w = self.mobile_base22d_laser_scanner_pose['orientation']['w']

        self.tf_broadcaster_static.sendTransform(t)

if __name__ == '__main__':
    mobileBase22d_laser_scannerTf = MobileBase22d_laser_scannerTf()
    rospy.spin()