...
class OarbotFakeNode(object):
    def __init__(self):
        rospy.init_node('oarbot_fake_node', anonymous=True)

        # Topic name to subscribe
        self.cmd_vel_base_topic_name = rospy.get_param("~cmd_vel_topic_name", "cmd_vel")
        ...
        self.base_vel_sub = rospy.Subscriber(self.cmd_vel_topic_name,Twist,self.base_vel_cb,queue_size=1)
