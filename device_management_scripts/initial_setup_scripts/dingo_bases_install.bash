...
# grep -qxF "export ROS_IP=$MY_IP" ~/.bashrc || echo "export ROS_IP=$MY_IP" >> ~/.bashrc; # already set in `ros-start` script of dingo_customization package
# grep -qxF 'export ROS_MASTER_URI=http://192.168.1.100:11311/' ~/.bashrc || echo 'export ROS_MASTER_URI=http://192.168.1.100:11311/' >> ~/.bashrc; # already set in `ros-start` script of dingo_customization package
